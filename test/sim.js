...
startRun(world, { startWave: Number(args.wave) || 0, arena: args.arena || 'space', bossRush: !!args.boss, mission: !!args.mission, missionType: args.type || null });
...
const summary = {
  ...
  arena: world.arena, kills: world.stats.kills, events: world.stats.events, evolved: world.stats.evolved, killedBy: world.stats.killedBy,
};
