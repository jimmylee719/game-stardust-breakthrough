...
const SHELL = ['./', 'index.html', 'css/style.css', 'manifest.json', 'icon-192.png', 'icon-512.png',
  'js/main.js', 'js/game.js', 'js/render.js', 'js/effects.js', 'js/audio.js', 'js/input.js', 'js/net.js', 'js/predict.js', 'js/account.js', 'js/analytics.js', 'js/themes.js', 'js/i18n.js',
