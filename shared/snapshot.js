...
export function snapshotWorld(world) {
  return {
    ...
    map: world.mods.mission ? { seed: world.mapSeed, type: world.missionType } : undefined, missionT: world.mods.mission ? r1(world.missionT) : undefined, alarm: world.alarm > 0 ? r1(world.alarm) : undefined, reinforce: world.mods.mission ? world.reinforce : undefined, reinforce0: world.mods.mission ? world.reinforce0 : undefined, radar: world.radar || undefined, side: world.mods.mission ? world.side.map(o => ({ kind: o.kind, x: o.x, y: o.y, r: o.r, p: r1(o.progress || 0), done: o.done, active: o.active || undefined })) : undefined,
    objectives: world.mods.mission ? world.objectives.map(o => ({ kind: o.kind, x: o.x, y: o.y, r: o.r, p: r1(o.progress || 0), done: o.done, active: o.active || undefined, need: o.need, count: o.count, spawned: o.spawned || undefined, eid: o.eid })) : undefined,
    ...
    players: world.players.map(p => ({
      ...
      r: p.r, hp: Math.round(p.hp), maxHp: p.maxHp, dead: p.dead, downed: p.downed, downTimer: r1(p.downTimer), respawnT: p.respawnT > 0 ? r1(p.respawnT) : undefined, reviveProgress: r1(p.reviveProgress), offline: p.offline,
      ...
      evolved: p.evolved || undefined, emp: p.emp > 0 ? r1(p.emp) : undefined, frozen: p.frozen > 0 ? r1(p.frozen) : undefined, hexed: p.hexed > 0 ? 1 : undefined, fog: p.fog || undefined, energy: Math.round(p.energy || 0), skill: p.skill, overdrive: p.overdrive > 0 ? r1(p.overdrive) : undefined, novaT: p.novaT > 0 ? r1(p.novaT) : undefined, fs: p.flags && p.flags.frontShield ? 1 : undefined, sb: p.flags && p.flags.shieldBash ? 1 : undefined, speedMul: p.speedMul !== 1 ? r1(p.speedMul * 100) / 100 : undefined, bs: p.bulletSize !== 1 ? r1(p.bulletSize * 100) / 100 : undefined, fa: p.weaponOn && p.weapon === 'flame' ? r1(p.fa * 100) / 100 : undefined, harvest: p.harvest || undefined, rebirth: p.flags && p.flags.rebirth ? 1 : undefined, fr: p.fr ? Math.round(p.fr) : undefined, fc: p.fc ? r1(p.fc * 100) / 100 : undefined,
    ...
    bullets: world.bullets.map(b => ({ id: b.id, x: r1(b.x), y: r1(b.y), vx: r1(b.vx), vy: r1(b.vy), size: b.size, homing: b.homing, burn: b.burn || undefined, rail: b.rail || undefined, slash: b.slash || undefined, element: b.element || undefined, rocket: b.rocket || undefined, glob: b.glob || undefined, pellet: b.pellet || undefined })),
    enemies: world.enemies.map(e => ({ id: e.id, type: e.type, x: r1(e.x), y: r1(e.y), vx: r1(e.vx), vy: r1(e.vy), r: e.r, hp: Math.round(e.hp), maxHp: Math.round(e.maxHp), color: e.color, hitFlash: e.hitFlash > 0 ? 1 : 0, ambient: e.ambient || undefined, ally: e.ally || undefined, life: e.ambient ? r1(e.life) : undefined, buffed: (e.buffSpeed > 0 || e.buffRapid > 0 || e.buffSpread > 0 || e.armored) ? 1 : undefined, burn: e.burn > 0 ? 1 : undefined, stun: e.stun > 0 ? 1 : undefined, slow: e.slow > 0 ? 1 : undefined, squash: r1(e.squash), wobble: r1(e.wobble), rot: r1(e.rot), elite: e.elite || undefined, tier: e.tier || undefined, lunge: e.lunge > 0 ? 1 : undefined, blinkFlash: e.blinkFlash > 0 ? 1 : undefined,
      element: e.element && e.element !== 'neutral' ? e.element : undefined, affixes: e.affixes && e.affixes.length ? e.affixes : undefined, sh: e.shieldHp > 0 ? 1 : undefined, ph: e.phaseT > 0 ? 1 : undefined, ta: e.type === 'turret' ? Math.round((e.ta || 0) * 100) / 100 : undefined, aimT: e.aimT > 0 ? r1(e.aimT) : undefined, aimA: e.aimT > 0 ? r1(e.aimA * 100) / 100 : undefined, fx: e.kind === 'warden' ? r1(e.fx * 100) / 100 : undefined, fy: e.kind === 'warden' ? r1(e.fy * 100) / 100 : undefined, lure: e.lure || undefined, hunter: e.hunter || undefined, warn: e.warn || undefined, cmd: e.cmdT > 0 ? 1 : undefined, fog: e.fog || undefined, poison: e.poison > 0 ? 1 : undefined })),
    enemyBullets: world.enemyBullets.map(b => ({ id: b.id, x: r1(b.x), y: r1(b.y), vx: r1(b.vx), vy: r1(b.vy), r: b.r, boss: !!b.boss, homing: b.homing ? 1 : undefined, missile: b.missile || undefined, wall: b.wall || undefined, kind: b.kind, ufo: b.ufo || undefined, life: b.kind === 'mine' || b.kind === 'mark' ? r1(b.life) : undefined })),
...
export function applySnapshot(world, prev, curr, t) {
  ...
  world.mods = s.mods || {};
  if (s.map) { if (world.mapSeed !== s.map.seed) { const m = genMap(s.map.seed, s.arena || 'space', s.map.type); world.mapSeed = s.map.seed; world.W = m.W; world.H = m.H; world.obstacles = m.obstacles; world.start = m.start; } world.missionType = s.map.type; world.objectives = s.objectives || []; world.extract = s.extract || null; world.missionT = s.missionT || 0; world.alarm = s.alarm || 0; world.reinforce = s.reinforce || 0; world.reinforce0 = s.reinforce0 || 0; world.side = s.side || []; world.radar = !!s.radar; }
