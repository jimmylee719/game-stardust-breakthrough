...
export function snapshotWorld(world) {
  return {
    ...
    map: world.mods.mission ? { seed: world.mapSeed, type: world.missionType } : undefined, missionT: world.mods.mission ? r1(world.missionT) : undefined, alarm: world.alarm > 0 ? r1(world.alarm) : undefined, reinforce: world.mods.mission ? world.reinforce : undefined,
